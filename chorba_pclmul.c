...
uint32_t
chorba_pclmul (uint32_t crc, char* buf, size_t len)
  {
    ...
    if (bytes_remaining >= 128)
      {
        ...
        while (bytes_remaining >= 512 + 64 + 16*8) {
            __m128i chorba8 = _mm_loadu_si128(data + 4);
            __m128i chorba7 = _mm_loadu_si128(data + 5);
            __m128i chorba6 = _mm_loadu_si128(data + 6);
            __m128i chorba5 = _mm_loadu_si128(data + 7);
            __m128i chorba4 = _mm_loadu_si128(data + 8);
            __m128i chorba3 = _mm_loadu_si128(data + 9);
            __m128i chorba2 = _mm_loadu_si128(data + 10) ^ chorba8;
            __m128i chorba1 = _mm_loadu_si128(data + 11) ^ chorba7;
            data += 8;
            bytes_remaining -= 16*8;
            in5 = _mm_loadu_si128(data + 4) ^ chorba6;
            in6 = _mm_loadu_si128(data + 5) ^ chorba5 ^ chorba8;
            in7 = _mm_loadu_si128(data + 6) ^ chorba4 ^ chorba8 ^ chorba7;
            in8 = _mm_loadu_si128(data + 7) ^ chorba3 ^ chorba7 ^ chorba6;

            // now we fold in1 onto in2
            // fold 8x because we stole a value
            __m128i fold_high1 = _mm_clmulepi64_si128(in1, shift1568_shift1504, 0x11);
            __m128i fold_low1 = _mm_clmulepi64_si128(in1, shift1568_shift1504, 0x00);
            in1 = _mm_xor_si128(in5, fold_high1);
            in1 = _mm_xor_si128(in1, fold_low1);
            __m128i fold_high2 = _mm_clmulepi64_si128(in2, shift1568_shift1504, 0x11);
            __m128i fold_low2 = _mm_clmulepi64_si128(in2, shift1568_shift1504, 0x00);
            in2 = _mm_xor_si128(in6, fold_high2);
            in2 = _mm_xor_si128(in2, fold_low2);
            __m128i fold_high3 = _mm_clmulepi64_si128(in3, shift1568_shift1504, 0x11);
            __m128i fold_low3 = _mm_clmulepi64_si128(in3, shift1568_shift1504, 0x00);
            in3 = _mm_xor_si128(in7, fold_high3);
            in3 = _mm_xor_si128(in3, fold_low3);
            __m128i fold_high4 = _mm_clmulepi64_si128(in4, shift1568_shift1504, 0x11);
            __m128i fold_low4 = _mm_clmulepi64_si128(in4, shift1568_shift1504, 0x00);
            in4 = _mm_xor_si128(in8, fold_high4);
            in4 = _mm_xor_si128(in4, fold_low4);
            in5 = _mm_loadu_si128(data + 8) ^ chorba2 ^ chorba6 ^ chorba5;
            in6 = _mm_loadu_si128(data + 9) ^ chorba1 ^ chorba4 ^ chorba5;
            in7 = _mm_loadu_si128(data + 10) ^ chorba3 ^ chorba4;
            in8 = _mm_loadu_si128(data + 11) ^ chorba2 ^ chorba3;

            // now we fold in1 onto in2
            fold_high1 = _mm_clmulepi64_si128(in1, shift544_shift480, 0x11);
            fold_low1 = _mm_clmulepi64_si128(in1, shift544_shift480, 0x00);
            in1 = _mm_xor_si128(in5, fold_high1);
            in1 = _mm_xor_si128(in1, fold_low1);
            fold_high2 = _mm_clmulepi64_si128(in2, shift544_shift480, 0x11);
            fold_low2 = _mm_clmulepi64_si128(in2, shift544_shift480, 0x00);
            in2 = _mm_xor_si128(in6, fold_high2);
            in2 = _mm_xor_si128(in2, fold_low2);
            fold_high3 = _mm_clmulepi64_si128(in3, shift544_shift480, 0x11);
            fold_low3 = _mm_clmulepi64_si128(in3, shift544_shift480, 0x00);
            in3 = _mm_xor_si128(in7, fold_high3);
            in3 = _mm_xor_si128(in3, fold_low3);
            fold_high4 = _mm_clmulepi64_si128(in4, shift544_shift480, 0x11);
            fold_low4 = _mm_clmulepi64_si128(in4, shift544_shift480, 0x00);
            in4 = _mm_xor_si128(in8, fold_high4);
            in4 = _mm_xor_si128(in4, fold_low4);
            in5 = _mm_loadu_si128(data + 12) ^ chorba1 ^ chorba2 ^ chorba8;
            in6 = _mm_loadu_si128(data + 13) ^ chorba1 ^ chorba7;
            in7 = _mm_loadu_si128(data + 14) ^ chorba6;
            in8 = _mm_loadu_si128(data + 15) ^ chorba5;
            ...
            in4 = _mm_xor_si128(in8, fold_high4);
            in4 = _mm_xor_si128(in4, fold_low4);
            in5 = _mm_loadu_si128(data + 16) ^ chorba4 ^ chorba8;
            in6 = _mm_loadu_si128(data + 17) ^ chorba3 ^ chorba8 ^ chorba7;
            in7 = _mm_loadu_si128(data + 18) ^ chorba2 ^ chorba8 ^ chorba7 ^ chorba6;
            in8 = _mm_loadu_si128(data + 19) ^ chorba1 ^ chorba7 ^ chorba6 ^ chorba5;
            ...
            in4 = _mm_xor_si128(in8, fold_high4);
            in4 = _mm_xor_si128(in4, fold_low4);
            in5 = _mm_loadu_si128(data + 20) ^ chorba4 ^ chorba8 ^ chorba6 ^ chorba5;
            in6 = _mm_loadu_si128(data + 21) ^ chorba3 ^ chorba4 ^ chorba8 ^ chorba7 ^ chorba5;
            in7 = _mm_loadu_si128(data + 22) ^ chorba2 ^ chorba3 ^ chorba4 ^ chorba7 ^ chorba6;
            in8 = _mm_loadu_si128(data + 23) ^ chorba1 ^ chorba2 ^ chorba3 ^ chorba8 ^ chorba6 ^ chorba5;
            ...
            in4 = _mm_xor_si128(in8, fold_high4);
            in4 = _mm_xor_si128(in4, fold_low4);
            in5 = _mm_loadu_si128(data + 24) ^ chorba1 ^ chorba2 ^ chorba4 ^ chorba8 ^ chorba7 ^ chorba5;
            in6 = _mm_loadu_si128(data + 25) ^ chorba1 ^ chorba3 ^ chorba4 ^ chorba7 ^ chorba6;
            in7 = _mm_loadu_si128(data + 26) ^ chorba2 ^ chorba3 ^ chorba8 ^ chorba6 ^ chorba5;
            in8 = _mm_loadu_si128(data + 27) ^ chorba1 ^ chorba2 ^ chorba4 ^ chorba8 ^ chorba7 ^ chorba5;
            ...
            in4 = _mm_xor_si128(in8, fold_high4);
            in4 = _mm_xor_si128(in4, fold_low4);
            in5 = _mm_loadu_si128(data + 28) ^ chorba1 ^ chorba3 ^ chorba4 ^ chorba8 ^ chorba7 ^ chorba6;
            in6 = _mm_loadu_si128(data + 29) ^ chorba2 ^ chorba3 ^ chorba7 ^ chorba6 ^ chorba5;
            in7 = _mm_loadu_si128(data + 30) ^ chorba1 ^ chorba2 ^ chorba4 ^ chorba6 ^ chorba5;
            in8 = _mm_loadu_si128(data + 31) ^ chorba1 ^ chorba3 ^ chorba4 ^ chorba5;
            ...
            in4 = _mm_xor_si128(in8, fold_high4);
            in4 = _mm_xor_si128(in4, fold_low4);
            in5 = _mm_loadu_si128(data + 32) ^ chorba2 ^ chorba3 ^ chorba4;
            in6 = _mm_loadu_si128(data + 33) ^ chorba1 ^ chorba2 ^ chorba3;
            in7 = _mm_loadu_si128(data + 34) ^ chorba1 ^ chorba2;
            in8 = _mm_loadu_si128(data + 35) ^ chorba1;
