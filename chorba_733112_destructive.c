...
uint32_t chorba_733112_destructive (uint32_t crc, char* buf, size_t len) {
    ...
    *((uint32_t*) (input)) ^= crc;
    ...
    for(; i + 733112+64 < len; i += 64) {
        ...
        in5 = *((uint64_t*) (input + i + (8*4)));
        in6 = *((uint64_t*) (input + i + (8*5)));
        in7 = *((uint64_t*) (input + i + (8*6)));
        in8 = *((uint64_t*) (input + i + (8*7)));
        ...
        int offset1 = 733112 - 333424;
        int offset2 = 733112;
        *((uint64_t*) (input + offset1 + (0*8) + i)) ^= out1;
        *((uint64_t*) (input + offset1 + (1*8) + i)) ^= out2;
        *((uint64_t*) (input + offset1 + (2*8) + i)) ^= out3;
        *((uint64_t*) (input + offset1 + (3*8) + i)) ^= out4;
        *((uint64_t*) (input + offset1 + (4*8) + i)) ^= out5;
        *((uint64_t*) (input + offset1 + (5*8) + i)) ^= out6;
        *((uint64_t*) (input + offset1 + (6*8) + i)) ^= out7;
        *((uint64_t*) (input + offset1 + (7*8) + i)) ^= out8;
        *((uint64_t*) (input + offset2 + (0*8) + i)) ^= out1;
        *((uint64_t*) (input + offset2 + (1*8) + i)) ^= out2;
        *((uint64_t*) (input + offset2 + (2*8) + i)) ^= out3;
        *((uint64_t*) (input + offset2 + (3*8) + i)) ^= out4;
        *((uint64_t*) (input + offset2 + (4*8) + i)) ^= out5;
        *((uint64_t*) (input + offset2 + (5*8) + i)) ^= out6;
        *((uint64_t*) (input + offset2 + (6*8) + i)) ^= out7;
        *((uint64_t*) (input + offset2 + (7*8) + i)) ^= out8;
    }
